...
const Button = ({text,showModal,setShowModal}) => {
  ...
  return (
    <>
    <button onClick={()=>setShowModal(!showModal)} className = 'mt-6 flex items-center font-semibold px-4   h-[40px] rounded-[100px] text-white bg-gradient-to-r from-green-600 to-[#ebc934] overflow-hidden 
